...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="sticky top-0 z-30 bg-[#ff7f5d] border-b border-[#43459b]/20 px-4 py-3 shadow-xl">
      <div className="max-w-4xl mx-auto flex items-center justify-between">
        
        {/* Brand & Offline Status */}
        <div className="flex items-center space-x-3">
          <div className="w-10 h-10 rounded-xl bg-[#43459b] p-0.5 shadow-md flex items-center justify-center">
          ...
          <div>
            <div className="flex items-center space-x-2">
              ...
              <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold bg-[#43459b] text-white">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            ...
            className="hidden sm:flex items-center space-x-2 px-3 py-1.5 rounded-xl bg-[#43459b] hover:bg-[#303273] transition-all text-xs text-white shadow-sm"
          >
            ...
            <span>
              <strong className="text-white">{directPeersCount}</strong> Direct •{' '}
              <strong className="text-white/90">{relayedPeersCount}</strong> Relayed
            </span>
          </button>

          {/* Tab Switches */}
          <div className="flex items-center bg-[#43459b] p-1 rounded-xl shadow-sm">
            <button
          ...
          <button
            ...
            className="p-2 rounded-xl bg-[#43459b] hover:bg-[#303273] text-white transition-all shadow-sm"
          >
          ...
          <button
            ...
            className={`p-2 rounded-xl transition-all ${
              activeTab === 'settings' ? 'bg-white text-[#43459b] shadow-md' : 'bg-[#43459b] text-white hover:bg-[#303273]'
            }`}
          >
